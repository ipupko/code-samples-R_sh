...
echo "Geno 85%" >> ${qc_dir}Reports/SNP_excluded.txt | wc -l demo_g85.hh >> ${qc_dir}Reports/SNP_excluded.txt
echo "Geno 90%" >> ${qc_dir}Reports/SNP_excluded.txt | wc -l demo_g90_s85.hh >> ${qc_dir}Reports/SNP_excluded.txt
echo "Geno 95%" >> ${qc_dir}Reports/SNP_excluded.txt | wc -l demo_g95_s90.hh >> ${qc_dir}Reports/SNP_excluded.txt

echo "Samples excluded" > ${qc_dir}Reports/Samples_excluded.txt
echo "Sample 85%" >> ${qc_dir}Reports/Samples_excluded.txt | wc -l demo_g85_s85.irem >> ${qc_dir}Reports/Samples_excluded.txt
echo "Sample 90%" >> ${qc_dir}Reports/Samples_excluded.txt | wc -l demo_g90_s90.irem >> ${qc_dir}Reports/Samples_excluded.txt
echo "Sample 95%" >> ${qc_dir}Reports/Samples_excluded.txt | wc -l demo_g95_s95.irem >> ${qc_dir}Reports/Samples_excluded.txt
...
report_dir=/cluster/project2/demo/${qc_dir}/Reports/
